...
🌟 اگه **پنل PbP** براتون مفید بوده، با حمایتتون بهم دلگرمی می‌دید 🌟
...
- [روش‌های راه‌اندازی](https://bia-pain-bache.github.io/PbP-Worker-Panel/fa/installation/wizard/)
- [راهنمای تنظیمات](https://bia-pain-bache.github.io/PbP-Worker-Panel/fa/configuration/)
- [نحوه‌ی استفاده](https://bia-pain-bache.github.io/PbP-Worker-Panel/fa/usage/)
- [پرسش‌های متداول (FAQ)](https://bia-pain-bache.github.io/PbP-Worker-Panel/en/faq/)
...
[![تعداد ستاره‌ها به مرور زمان](https://starchart.cc/bia-pain-bache/PbP-Worker-Panel.svg?variant=adaptive)](https://starchart.cc/bia-pain-bache/PbP-Worker-Panel)
