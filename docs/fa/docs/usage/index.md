...
قبل از هر چیز برنامه خودتون رو به آخرین نسخه بروزرسانی کنید و یا به جدول زیر مراجعه کنید. اینها برنامه‌های تست شده و معتبر برای استفاده از PbP هستن و پشتیبانی میشن، میتونید با مسئولیت خودتون از برنامه‌های دیگه استفاده کنید.
