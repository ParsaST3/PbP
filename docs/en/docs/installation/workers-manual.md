...
First, download the Worker code from from here.
...
Suppose your domain is `pbp.com`. You can enter the main domain or a subdomain, like `xyz.pbp.com`, then click `Add domain`.
...
You can then access your panel via `https://xyz.pbp.com/panel` and retrieve new subscriptions.
